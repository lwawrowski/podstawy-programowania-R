...
Jeśli chcemy zakcentować fakt, że zmienne są mierzone na skali porządkowej dodajemy argument `ordered=TRUE`:
...
Wówczas można uzykać do nich dostęp poprzez symbol `$` i podaną nazwę:
...
Wyodrębnienie informacji o wzroście tylko dla kobiet i wyznacznie średniej:
